...
def main(N, alpha_P, alpha_D, l, D, d, on_sphere, init_overlap, n, device, data_PATH, epochs, learning_rate, valid_every, max_grad, P_generalization, L_train, L_test):
    P = int(alpha_P * N)
    D = int(alpha_D * N)
    ...
    hist_loss, hist_vloss, hist_asymm, hist_diff, hist_J_norm = train_model(
        model, dataloader, dataloader_f,dataloader_generalization, epochs, learning_rate, max_grad, device, data_PATH, model_name, init_overlap, n, l, fake_opt, J2, norm_J2, valid_every, ALPHA, epochs_to_save, model_name_base, save,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--L_train", type=int, default=3)
    parser.add_argument("--L_test", type=int, default=3)

    args = parser.parse_args()

    # Run the main function with the parsed arguments
    main(args.N, args.alpha_P, args.alpha_D, args.l, args.D, args.d, args.on_sphere, args.init_overlap, args.n, args.device, args.data_PATH, args.epochs, args.learning_rate, args.max_grad, args.valid_every, args.P_generalization, args.L_train, args.L_test)